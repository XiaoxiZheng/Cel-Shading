...
// New Function added here, no implementation required
// No new implementation required
//---------------------------------------------------------------
// returns I, the identity matrix
STMatrix4 IdentityMatrix (void)
{
    ...
    STMatrix4 outMatrix = initMatrix;
    return(outMatrix);
}

// returns the matrix a float array
// m - input 4x4 matrix
// mout - output array
...
// returns the point  as float array with 1 in the last entry
// m - input point of 3 floats
// mout - output array of 4 floats
